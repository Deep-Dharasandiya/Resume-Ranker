...
import 'LoaderHomePageRecruiterToUploadVacancy.dart';
import 'Show_Resumes_Recruiter.dart';
import 'UploadVacancy.dart';
import 'main.dart';

class Homepage1 extends StatefulWidget {
  Homepage1(this.email);
  final String email;
  @override
  _UploadVacncy createState() => new _UploadVacncy(email);
}

class _UploadVacncy extends State<Homepage1> {
  _UploadVacncy(email);
  ...
  void networkcheck(int r) async {
    ...
    if (connectivityResult != ConnectivityResult.mobile && connectivityResult != ConnectivityResult.wifi) {
      ...
      {
        Navigator.push(context, MaterialPageRoute(builder: (context){
          return ShowResume_Recruiter(widget.email);
        }));
      }
      else if(r==3)
      {
                            ...
                            child:Column(
                              children: <Widget>[
                                ...
                                InkWell(
                                  ...
                                  child:Center(
                                    child: Text("Upload Skil Priority",
                                        style: TextStyle(
                                            color: Colors.blue,
                                            fontFamily: "design.graffiti.comicsansms",
                                            fontSize: 18,
