...
class VacancyRequiredSkills extends StatefulWidget {
  VacancyRequiredSkills(this.email,this.post);
  String email,post;
  @override
  _VacancyRequiredSkills createState() => _VacancyRequiredSkills(email,post);
}

class _VacancyRequiredSkills extends State<VacancyRequiredSkills> {
  _VacancyRequiredSkills(email,post);
  ...
  void deleteskill(String d)async{
    ...
    final response = await http.post(
        "http://resumeranker.hopto.org/delete_vacancy_required_skilla.php",
        body: {
          "A": d,
        }
    );
  ...
  void fetchtechnicalskill() async {
    final response = await http.post(
        "http://resumeranker.hopto.org/get_vacancy_required_skills.php",
        body: {
          "A": widget.email,
          "B":widget.post,
        }
  ...
  void insert_person_info() async {
    final response = await http.post(
        "http://resumeranker.hopto.org/insert_vacancy_required_skills.php",
        body: {
          "A":widget.email,
          "B":Skill,
          "C":skill_level,
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text("Required Skills", style: TextStyle(
            color: Colors.black, fontFamily: 'design.graffiti.comicsansms'),),
      ),
